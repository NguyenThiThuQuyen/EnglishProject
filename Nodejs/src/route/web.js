...
let initWebRoutes = (app) => {
    ...
    router.get(`/api/get-all-vocab-from-lesson`, vocabController.checkVocabFromLessonId)
    ...
    router.get('/api/search-word-meaning-to-vocab', vocabController.handleSearchWordMeaningToVocab);
